...
class laser_gcode(inkex.Effect):
    ...
    def export_gcode(self, gcode):
        ...
        for x in range(1, self.options.passes):
            ...
            undoz += "G0 Z" + self.options.pass_depth + "\n"
        f = open(self.options.directory + self.options.file, "w")
        f.write(
            "M452\n" + self.header + "G0 F" + self.options.travel_speed + "\n" + gcode + "G91\n" + undoz + "G90\n" + self.options.laser_off_command + "\n" + self.footer)
        f.close()
    ...
    def __init__(self):
        ...
        self.OptionParser.add_option("", "--laser-power", action="store", type="int", dest="laser_power", default="100",
                                     help="Laser power (%)")
        ...
        self.OptionParser.add_option("", "--unit", action="store", type="string", dest="unit",
                                     default="G21 (All units in mm)", help="Units")
    ...
    def generate_gcode(self, curve, layer, depth):
        ...
        for i in range(1, len(curve)):
            ...
            if s[1] == 'move':
                # RP add + "G1" + c(si[0])  + "\n G4 P50\n" to solve late laser turnon issue
    ...
    def effect(self):
        ...
        self.tools = {
            ...
            # RP added delay before path
            "gcode before path": (
                        self.options.laser_command + " S" + str(int(self.options.laser_power * 2.55001)) + "\n"),
